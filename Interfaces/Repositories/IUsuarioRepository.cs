...
namespace ApiCardapio.Interfaces.Repositories
{
    ...
    {
        Task<PerfilUsuarioModel> RecuperarUsuarioLogin(string username, string senha);
        Task<UsuarioEstabelecimentoModel> RecuperarEstabelecimentoUsuario(string username);
